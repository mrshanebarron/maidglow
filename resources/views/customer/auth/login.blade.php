    ...
    <main class="relative flex-1 flex items-center justify-center px-6 py-12">
        <div class="w-full max-w-md">
            <div class="text-center mb-10">
                ...
                <p class="text-sage-500">Sign in to manage your appointments</p>
            </div>

            <!-- Demo credentials -->
            <div class="mb-8 bg-sage-50 border border-sage-200 rounded-xl p-4">
                <p class="text-sm text-sage-600">
                    <span class="font-medium">Demo:</span> jennifer.smith@email.com / customer123
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('customer.login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', 'jennifer.smith@email.com') }}" required autofocus
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" value="customer123" required
                           class="w-full bg-white border border-sage-200 rounded-xl px-4 py-3.5 text-ink transition-all focus:outline-none focus:border-sage-400 focus:ring-2 focus:ring-sage-100">
                </div>
            ...
            <p class="mt-8 text-center text-sm text-sage-500">
                New customer? <a href="{{ route('booking.calculator') }}" class="font-medium text-ink hover:text-sage-600 transition-colors">Book your first cleaning</a>
            </p>
        </div>
    </main>
