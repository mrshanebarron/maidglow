<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        <x-nav-link :href="route('tech.dashboard')" :active="request()->routeIs('tech.dashboard')">
                            My Jobs
                        </x-nav-link>
                        <x-nav-link :href="route('tech.earnings')" :active="request()->routeIs('tech.earnings')">
                            Earnings
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                <x-responsive-nav-link :href="route('tech.dashboard')" :active="request()->routeIs('tech.dashboard')">
                    My Jobs
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('tech.earnings')" :active="request()->routeIs('tech.earnings')">
                    Earnings
                </x-responsive-nav-link>
            @endif
        </div>
